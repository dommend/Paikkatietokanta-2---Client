        ...
        <div className="innerwidth">
          <div className="innercontainer">
            ...
            <div className="row"><div className="col-sm">
              ...
              <p>
                Paikkatietokanta on <a href="http://penttinen.fi/">Jani Penttisen</a> päättöprojektina syntynyt sivusto. Paikkatietokannan tarkoitus on yhdistää valokuvaharrastus, historiallinen dokumentointi ja ammatillinen focus kehittyä paremmaksi koodariksi. Sivuston on tarkoitettu henkilökohtaiseen käyttöön.</p>
              ...
              <a href="https://github.com/dommend/paikkatietokanta" style={{ margin: '40px 0px 20px 0px', padding: '25px' }} className="btn btn-outline-info btn-block">
                ...
                <br />
                <strong>Paikkatietokanta 1.4.9 (Client with Admin)</strong> <br />
                <small>Huom. Versiossa ei olla eroteltu ylläpitoa ja käyttäjärajapintaa.</small>
              </a>
            </div>
            ...
            <div className="row space">
              <div className="col-sm">
                ...
                <h4>Ohjeet sivuston ajamiseen (Paikkatietokanta 2.0 - Client)</h4>
                ...
                <blockquote>
                  <ol>
                    ...
                    <li>Luo esimerkin mukainen <code>.env.local</code> -tiedosto kansion juureen:
                    <blockquote>
                        <code>PORT=8080 <br />
                    ...
                    REACT_APP_OW_API="12345"</code>
                      </blockquote>
                      <small>
                        <code>REACT_APP_FLICKR_API</code> on Flickr:n api (<a href="https://www.flickr.com/services/apps/create/apply">https://www.flickr.com/services/apps/create/apply</a>)<br />
                        <code>REACT_APP_FLICKR_USERNAME</code> on Flickr:n käyttäjänimi (<a href="https://help.flickr.com/find-your-flickr-login-id-HytypXj1Q">https://help.flickr.com/find-your-flickr-login-id-HytypXj1Q</a>)<br />
                        <code>REACT_APP_OW_API</code> on OpenWeather api (<a href="https://openweathermap.org/">https://openweathermap.org/</a>)<br />
                    Huom! Sivusto käyttää karttoina <a href="https://stadiamaps.com/">Stadiamaps.com</a>:n kartta layeriä. Jotta kartat näkyisivät verkossa oikein, tulee sinun tehdä tunnus palveluun.</small>
                    </li>
                    <li>Aja <code>node.server</code> tai <code>npm run-script dev</code> -- Jos tietokantoja ei ole, ne luodaan. <code>Server.js</code> pyörii portissa 8080.</li>
                    <li>Aja <code>npm start</code> -- Käynnistää sivuston portissa 8081.</li>
                  </ol>
                </blockquote>

                <h5>Porteista</h5>
                <p>Portien asetukset määritetään <code>.env.local</code> -tiedososta. Varsinaiset asetukset löytyvät tiedostoista <code>server.js</code> ja <code>src/http-commons.</code></p>

                <p><code>Node server.js</code> pyörii portissa 8080. <br />
                Paikkatitokanta (<code>npm start</code>) pyörii portissa 8081</p>

                <h5>Ennen kuin ajat build-scriptin</h5>
                <p>Ennen kuin ajat build-scriptin, käy muuttamassa <code>REACT_APP_API_URL</code> oikeaksi <code>.env.local</code> -tiedostosta. Tarkista myös <code>'homepage address'</code> tiedostosta <code>package.json.</code> Ajattaessa lokaalisti <code>homepage address</code> voi olla <code>"./"</code>. Mikäli osoite on väärin, sivusto avautuu pelkkänä valkoisena näkymänä. Verkkoa varten tämän voi muuttaa vastaamaan verkkotunnusta.</p>
                ...
                <h4>Ohjeet sivuston ajamiseen (Paikkatietokanta 2.0 - Admin)</h4>

                <p>Ohjeet ovat muuten samat, mutta <code>.env.local</code> -tiedoston sisältö on seuraava:</p>
